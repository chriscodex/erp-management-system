...
import { PdfNotaDeVenta } from '@/app/ventas/[ventaId]/nota-venta/_components/pdf/pdfNotaVenta';
import { EmpresasSelect } from '@/app/ventas/[ventaId]/_components/empresasSelect';

export function ImprimirNotaDeVentaButton({ ventaData, empresas }) {
  ...
  const handleDownloadPDF = async () => {
    setLoading(true);
    try {
      const codigoNotaDeVenta = ventaData?.code;
