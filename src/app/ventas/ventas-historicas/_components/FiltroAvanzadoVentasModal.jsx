...
export function FiltroAvanzadoVentasModal({
  abierto,
  setAbierto,
  onAplicarFiltros,
}) {
  const [fechaDesdeDate, setFechaDesdeDate] = useState(new Date());
  const [fechaHastaDate, setFechaHastaDate] = useState(new Date());
              ...
              <div className="relative flex flex-col gap-2">
                ...
                <div className="flex justify-end gap-2 mt-4">
                  <Button
                    ...
                    variant="outline"
                    onClick={() => {
                      limpiarFiltroAvanzadoVentasModal(form);
                    }}
                  >
                    Limpiar
                  </Button>
