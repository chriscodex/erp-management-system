...
import { AddProveedorForm } from '@/app/contactos/proveedores/_components/sheets/addProveedor/addProveedorForm';

export function SheetAddProveedorWrapper() {
    ...
    <div>
      ...
      {isSheetOpen && (
        <Sheet open={isSheetOpen} onOpenChange={handleCloseSheet}>
          <AddProveedorForm onClose={handleCloseSheet} />
        </Sheet>
      )}
    </div>
  );
