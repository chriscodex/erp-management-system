...
import { AddClienteForm } from '@/app/contactos/clientes/_components/sheets/addCliente/addClienteForm';

export function SheetAddClienteWrapper() {
    ...
    <div>
      ...
      {isSheetOpen && (
        <Sheet open={isSheetOpen} onOpenChange={handleCloseSheet}>
          <AddClienteForm onClose={handleCloseSheet} />
        </Sheet>
      )}
    </div>
  );
