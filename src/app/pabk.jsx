...
import { Bike, DollarSign, Package, TrendingUp, Users, Building, Tag, List } from 'lucide-react'
...
const inventoryData = [
  ...
  { name: 'Accesorios', cantidad: 300 },
  { name: 'Repuestos', cantidad: 500 },
]

export default function DashboardPage() {
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-3xl font-bold mb-6">Dashboard de Gestión de Inventario</h1>
      
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <StatCard title="Total Motos" value="1,234" icon={<Bike />} />
        <StatCard title="Ingresos Mensuales" value="$123,456" icon={<DollarSign />} />
        <StatCard title="Productos en Stock" value="5,678" icon={<Package />} />
        <StatCard title="Crecimiento Anual" value="12.3%" icon={<TrendingUp />} />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <QuickAccessCard
          ...
          linkText="Ver Sub Empresas"
          linkHref="/sub-empresas"
        />
        <QuickAccessCard
          title="Marcas y Categorías"
          description="Administra marcas y categorías de productos"
          icon={<Tag className="h-6 w-6" />}
          linkText="Gestionar"
          linkHref="/marcas-categorias"
        />
        <QuickAccessCard
