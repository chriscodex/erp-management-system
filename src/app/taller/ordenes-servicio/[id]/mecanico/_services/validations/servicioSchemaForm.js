...
export const servicioSchema = z.object({
    descripcion: z.string({ required_error: "Ingrese la descripción" }).min(3, "La descripción debe tener al menos 3 caracteres").max(100, "Máximo 100 caracteres"),
    precio: z.union([
        z.number({
    ...
    //     }),
    // fecha: z.date({ required_error: "Debe ingresar una fecha válida" }),
});
