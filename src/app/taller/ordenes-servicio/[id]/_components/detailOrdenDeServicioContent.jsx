...
export function DetailOrdenDeServicioContent({ ordenDeServicioData, empresas }) {
  console.log("ordenDeServicioData", ordenDeServicioData);

  const precioTotal = ordenDeServicioData?.productos?.reduce((acc, product) => {
  ...
  return (
    <Card className="w-full max-w-7xl mx-auto">
      <CardHeader className="flex flex-col gap-2 items-center justify-between space-y-0 pb-4 md:flex-row  ">
        ...
        <EmitirComprobanteOrdenDeServicioButton ordenDeServicioData={ordenDeServicioData} empresas={empresas}/>
      </CardHeader>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-2">
                ...
                {ordenDeServicioData?.comentarios && (
                  <p>
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      <span className="font-bold text-lg">
                        Total: S/.{formatMoney(precioTotal)}
                      </span>
                    </TableCell>
                  </TableRow>
                </TableBody>
