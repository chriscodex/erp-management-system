...
import { finalizarNotaVentaRequestClient } from '@/app/taller/ordenes-servicio/[id]/nota-venta/_services/requests';
 ...
 */
export function FinalizarNotaVentaAlert({
  isOpen,
  setIsOpen,
  ordenServicioId,
  ...
  const handleFinalizarOrdenDeServicio = async () => {
    try {
      setIsOpen(false);
      toast.promise(finalizarNotaVentaRequestClient(ordenServicioId), {
      ...
      <AlertDialog open={isOpen} onOpenChange={setIsOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Esta acción no se puede deshacer. Esta orden de servicio quedará
              como finalizada y se guardará en el historial de órdenes de
              servicio.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              ...
              onClick={handleFinalizarOrdenDeServicio}
            >
              Continuar
            </AlertDialogAction>
          </AlertDialogFooter>
