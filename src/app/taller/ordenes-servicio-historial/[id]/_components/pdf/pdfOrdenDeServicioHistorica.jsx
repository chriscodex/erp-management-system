...
import { stylesOrdenDeServicioHistorica } from "@/app/taller/ordenes-servicio-historial/[id]/_components/pdf/stylesOrdenDeServicioHistorica.js";
import {
  formatDateLong,
} from "@/lib/formateador";

const styles = StyleSheet.create(stylesOrdenDeServicioHistorica);

export function PdfOrdenDeServicioHistorica({ ordenDeServicioHistoricaData }) {
  const currentTime = formatDateLong(new Date().toISOString(), false);

  const codigoOrdenDeServicioHistorica = ordenDeServicioHistoricaData?.code;
      ...
      <Page size="A4">
        ...
        <View style={styles.body}>
          <View style={styles.datosEmpresaOrdenDeServicioContainer}>
            ...
            <View style={styles.datosOrdenDeServicioHistoricaContainer}>
              <View style={styles.datosOrdenDeServicioHistorica}>
                <Text style={styles.datosOrdenDeServicioHistoricaBold}>
                  Orden de Servicio #
                </Text>
                <Text> {codigoOrdenDeServicioHistorica}</Text>
              </View>
              <View style={styles.datosOrdenDeServicioHistorica}>
                <Text style={styles.datosOrdenDeServicioHistoricaBold}>
                  Fecha de emisión:{" "}
            ...
            <View style={styles.datosMoto}>
              ...
              {ordenDeServicioHistoricaData?.moto?.categoria && (
                <View style={styles.datosMotoInfo}>
                  ...
                  <Text>{ordenDeServicioHistoricaData.moto.categoria}</Text>
                </View>
              )}
              {ordenDeServicioHistoricaData?.moto?.marca && (
                <View style={styles.datosMotoInfo}>
                  <Text style={styles.datosMotoInfoTitle}>{"Marca: "}</Text>
                  <Text>{ordenDeServicioHistoricaData.moto.marca}</Text>
                </View>
              )}
            </View>
          </View>

          <View style={styles.ordenDeServicioHistoricaTitleContainer}>
            <Text style={styles.ordenDeServicioHistoricaTitle}>
              Orden de Servicio
            </Text>
          </View>
          <View style={styles.ordenDeServicioHistoricaSubTitleContainer}>
            <View style={styles.ordenDeServicioHistoricaSubTitle}>
              <Text style={styles.ordenDeServicioHistoricaSubTitleBold}>
                Fecha de ingreso:{" "}
              </Text>
              <Text>
                {formatDateLong(
            ...
            {ordenDeServicioHistoricaData?.origenServicio && (
              <View style={styles.datosMotoInfo}>
          ...
          <View style={styles.table}>
            ...
            {/* Filas de productos */}
            {ordenDeServicioHistoricaData?.productos?.map((item) => (
            ...
            {ordenDeServicioHistoricaData?.servicios?.map((item) => (
          ...
          {/* <View style={styles.AdditionalInfo}>
            ...
            <Text>
              ...
              {formatDateShort(ordenDeServicioHistoricaData?.fechaValidez, false)}. Luego de
