...
export default async function OrdenesDeServicioHistoricasPage() {
  ...
  const { ordenesDeServicioHistoricas, status } = await getAllOrdenesDeServicioHistoricasRequestServer();

  const ordenesDeServicioHistoricasSorted = sortByUpdateDateDesc(ordenesDeServicioHistoricas);
