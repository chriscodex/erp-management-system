...
export const columnsOrdenesDeServicioHistoricas = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return <div className="text-center">{totalProductos} / {totalServicios}</div>;
    },
  },
  {
    id: "Total",
    ...
    cell: ({ row }) => {
      ...
      return <div className="text-start">S/ {totalOrdenDeServicio.toFixed(2)}</div>;
    },
  },
  {
    id: "actions",
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <div
                ...
                onClick={() => router.push(`/taller/ordenes-servicio-historial/${id}`)}
              >
