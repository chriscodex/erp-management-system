...
import { deleteUnitProductRequestClient } from '@/app/inventario/productos/[id]/_services/requests';
...
export function DeleteUnitProductAlert({
  ...
  const handleConfirmationDelete = async () => {
    try {
      setIsOpen(false);
      toast.promise(deleteUnitProductRequestClient(productId, unitProductId), {
        loading: 'Eliminando...',
        success: () => {
