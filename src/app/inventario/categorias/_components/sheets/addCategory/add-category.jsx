...
import { createCategoryRequestClient } from '@/app/inventario/categorias/_services/requests';
...
export function AddCategoryForm({ segments, onClose }) {
  ...
  const onSubmit = handleSubmit(async (data) => {
    ...
    toast.promise(createCategoryRequestClient(data, setFormSubmitIsLoading), {
      loading: 'Creando...',
      success: () => {
        clearErrors();
        resetForm();
