...
import { AddProveedorForm } from '@/app/inventario/motos/pedidos/_components/sheets/addProveedor/addProveedorForm';


export function SheetAddProveedorWrapper({onAddProveedor}) {
      ...
      <div>
        ...
        {isSheetOpen && (
          <Sheet open={isSheetOpen} onOpenChange={handleCloseSheet}>
            <AddProveedorForm onClose={handleCloseSheet} onAddProveedor={onAddProveedor} />
          </Sheet>
        )}
      </div>
    );
