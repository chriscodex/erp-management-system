...
import { deletePedidoRequestClient } from '@/app/inventario/motos/pedidos/_services/requests';
 ...
 */
export function DeletePedidoAlert({
  isOpen,
  setIsOpen,
  pedidoId,
  ...
  const handleConfirmationDeletePedido = async () => {
    try {
      setIsOpen(false);
      toast.promise(deletePedidoRequestClient(pedidoId), {
        loading: 'Eliminando...',
        success: () => {
        ...
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              ...
              onClick={handleConfirmationDeletePedido}
            >
              Continuar
            </AlertDialogAction>
          </AlertDialogFooter>
