...
import { deleteModeloRequestClient } from '@/app/inventario/motos/modelos/_services/requests';
 ...
 */
export function DeleteModeloAlert({
  isOpen,
  setIsOpen,
  id,
  ...
  const handleConfirmationDeleteModelo = async () => {
    try {
      setIsOpen(false);
      toast.promise(deleteModeloRequestClient(id), {
        loading: 'Eliminando...',
        success: () => {
      ...
      <AlertDialog open={isOpen} onOpenChange={setIsOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Esta acción no se puede deshacer. Este modelo será permanentemente
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              ...
              onClick={handleConfirmationDeleteModelo}
            >
              Continuar
            </AlertDialogAction>
          </AlertDialogFooter>
