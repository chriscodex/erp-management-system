...
import { AddGastoMotoForm } from '@/app/inventario/motos/modelos/[modeloId]/unidades/[unidadId]/gastos/_components/sheets/addGastoMoto/addGastoMotoForm';

export function SheetAddGastoMotoWrapper({ motoId }) {
    ...
    <div>
      ...
      {isSheetOpen && (
        <Sheet open={isSheetOpen} onOpenChange={handleCloseSheet}>
          <AddGastoMotoForm onClose={handleCloseSheet} motoId={motoId} />
        </Sheet>
      )}
    </div>
  );
