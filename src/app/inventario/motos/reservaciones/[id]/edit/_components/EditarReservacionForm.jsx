...
export function EditarReservacionForm({ reservacionData }) {
  ...
  const form = useForm({
    resolver: zodResolver(updateReservacionSchema),
    defaultValues: {
      identificador:
  ...
  const onSubmit = handleSubmit(async () => {
    ...
    if (reservacionData?.cliente?.tipo === 'persona') {
      updateObject['cliente'] = {
        ...
        datos: {
          ...
          nombres: formData?.cliente?.datos?.nombres,
          apellidos: formData?.cliente.datos?.apellidos,
          celular: formData?.cliente.datos?.celular,
          email: formData?.cliente?.datos?.email,
        },
      };
    }
    ...
    if (reservacionData?.cliente?.tipo === 'empresa') {
      updateObject['cliente'] = {
        ...
        datos: {
          ...
          nombre: formData?.cliente?.datos?.nombre,
          celular: formData?.cliente.datos?.celular,
          email: formData?.cliente?.datos?.email,
        },
      };
    ...
    updateObject['moto'] = {
      nombre: formData?.moto?.nombre,
      descripcion: formData?.moto?.descripcion,
      categoria: {
        nombre: formData?.moto?.categoria?.nombre,
      },
      marca: {
    ...
    toast.promise(
      updateReservacionRequestClient(updateObject, setFormSubmitIsLoading),
      {
        loading: 'Editando...',
        success: (response) => {
          console.log(response);
          clearErrors();
          router.push(`/inventario/motos/reservaciones/${reservacionData._id}`);
