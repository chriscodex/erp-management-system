...
import { deleteReservacionRequestClient } from '@/app/inventario/motos/reservaciones/[id]/_services/requests';
...
export function DeleteReservacionAlert({
  ...
  const handleConfirmationDeleteProduct = async () => {
    try {
      setIsOpen(false);
      toast.promise(deleteReservacionRequestClient(reservacionId), {
        loading: 'Eliminando...',
        success: () => {
