...
export class ModeloPedidoService {
  ...
  async getModeloPedidoByData(modeloPedidoData) {
    try {
      const modeloPedidoFound =
        await this.modeloPedidoRepository.getModeloPedidoByData(
          modeloPedidoData,
        );
  ...
  async createModeloPedido(modeloPedidoData) {
    try {
      ...
      const modeloPedidoValidated =
        createModeloPedidoSchema.safeParse(modeloPedidoData);
      ...
      const modeloPedidoCreated =
        await this.modeloPedidoRepository.createModeloPedido(
          modeloPedidoObject,
        );
  ...
  async updateModeloPedido(modeloId, modeloPedidoData) {
    try {
      const modeloPedidoValidated =
        updateModeloPedidoSchema.safeParse(modeloPedidoData);
      ...
      const modeloPedidoUpdated =
        await this.modeloPedidoRepository.updateModeloPedido(
          modeloId,
          modeloPedidoData,
        );
  ...
  async deleteModeloPedido(id) {
    try {
      const modeloPedidoDeleted =
        await this.modeloPedidoRepository.deleteModeloPedido(id);
