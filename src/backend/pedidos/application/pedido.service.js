...
export class PedidoService {
  ...
  async getAllPedidosByData(pedidoData) {
    try {
      const pedidoFound = await this.pedidoRepository.getAllPedidosByData(
        pedidoData
      );
  ...
  async getPedidoByData(pedidoData) {
    try {
      const pedidoFound = await this.pedidoRepository.getPedidoByData(
        pedidoData
      );
  ...
  async createPedido(pedidoData) {
    try {
      ...
      // Crear el pedidoo
      const pedidoCreated = await this.pedidoRepository.createPedido(
        pedidoObject
      );
