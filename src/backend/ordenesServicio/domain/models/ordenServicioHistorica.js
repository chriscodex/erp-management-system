...
const ordenServicioHistoricaSchema = new Schema(
  {
    code: {
      type: String,
      required: [true, 'El code es requerido en el schema de ordenes de servicio'],
      unique: true,
    },
    cliente: {
      clienteId: {
    ...
    moto: {
      ...
      nombre: {
        type: String,
        required: [false, 'El nombre de la moto es requerido en el schema de ordenes de servicio'],
      },
      descripcion: {
        type: String,
        required: false,
    ...
    fechaIngreso: {
      type: Date,
      required: [true, "La fecha de ingreso es requerida en el schema de ordenes de servicio"],
    },
    origenServicio: {
      type: String,
      required: [true, 'El tipo de servicio es requerido en el schema de ordenes de servicio'],
    ...
    productos: [
      {
        ...
        estado: {
          type: String,
          required: [true, 'El estado es requerido en el schema de ordenes de servicio'],
          enum: [
            'disponible',
            'dañado',
            'desaparecido',
        ...
        stock: {
          type: Number,
          required: [true, 'El stock es requerido en el schema de ordenes de servicio'],
    ...
    pago: {
      montoEstimado: {
        type: Number,
        required: [false, "El monto estimado es requerido en el schema de ordenes de servicio"],
    ...
    fechaEntregaEstimada: {
      type: Date,
      required: [false, "La fecha de entrega estimada es requerida en el schema de ordenes de servicio"],
    },
    estado: {
      type: String,
      required: [false, "El estado es requerido en el schema de ordenes de servicio"],
      enum: ["pendiente", "diagnosticando", "esperando-repuestos", "en-reparacion", "en-mantenimiento", "finalizado", "entregado"],
    },
    servicios: [
      {
        descripcion: {
