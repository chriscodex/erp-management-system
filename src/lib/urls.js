...
export const updateProductClientUrl = '/api/products';
...
export const deleteGastoClientUrl = '/api/products';
export const updateGastoClientUrl = '/api/products';
...
export const deleteReservacionClientUrl = '/apireservaciones';
